...
\title{\Large\textbf{高エネルギー物理学1 レポート課題}}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{第1問_(1).png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{第1問_(2).png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{第1問_(3).png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{第2問_(1).png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{第2問_(2).png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[scale=0.5]{第2問_(3).png}
\end{figure}
...
\begin{align*}
    ...
    \text{シグマバリオン}(I=1): \quad & |\Sigma^+\rangle = |1, 1\rangle, \quad |\Sigma^0\rangle = |1, 0\rangle, \quad |\Sigma^-\rangle = |1, -1\rangle
\end{align*}
...
\subsection*{ローレンツ変換による実験室系$S$への変換}
...
\]
となる。したがって、実験室系で見た2つの光子の運動方向がなす角度は約$15.4^\circ$($0.268\text{ rad}$)である。
